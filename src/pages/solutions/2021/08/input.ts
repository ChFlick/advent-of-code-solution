export const input = `badc bd dbeaf cfdbge dfb cfbdea efbag edcfgab dcafe degfca | eacfd acdfbe cbdegf fcbaedg
...
export const testInput = `be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb |
